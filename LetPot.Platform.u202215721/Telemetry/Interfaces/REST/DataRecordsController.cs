...
using LetPot.Platform.u202215721.Telemetry.Interfaces.REST.Transform;
using Microsoft.AspNetCore.Mvc;
using Swashbuckle.AspNetCore.Annotations;

namespace LetPot.Platform.u202215721.Telemetry.Interfaces.REST;
    ...
    IDataRecordCommandService dataRecordCommandService) : ControllerBase
{
    ...
    public async Task<IActionResult> CreateDataRecord([FromBody] CreateDataRecordResource resource)
    {
        try
        {
            ...
            // Parse OperationMode
            if (!Enum.TryParse<Telemetry.Domain.Model.ValueObjects.EOperationMode>(
            ...
            if (!Enum.TryParse<Telemetry.Domain.Model.ValueObjects.EOperationPhase>(
